...
from app.solidlsp.ls_utils import FileUtils, PlatformUtils
...
class KotlinLanguageServer(SolidLanguageServer):
    ...
    def _setup_runtime_dependencies(
        ...
        if not os.path.exists(kotlin_script):
            ...
            FileUtils.download_and_extract_archive(
                logger,
                kotlin_dependency["url"],
                static_dir,
                kotlin_dependency["archiveType"],
            )
        ...
        if os.path.exists(kotlin_script):
            ...
            logger.log(
                f"Using Kotlin Language Server script at {kotlin_script}", logging.INFO
            )
        else:
