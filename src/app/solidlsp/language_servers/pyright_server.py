    ...
    def _start_server(self):
        ...
        def check_experimental_status(params):
            ...
            if params.get("quiescent") == True:
                self.logger.log(
                    "Received experimental/serverStatus with quiescent=true",
                    logging.INFO,
                )
        ...
        self.logger.log(
            f"Received initialize response from pyright server: {init_response}",
            logging.INFO,
        )
        ...
        self.logger.log(
            "Waiting for Pyright to complete initial workspace analysis...",
            logging.INFO,
        )
        if self.analysis_complete.wait(timeout=5.0):
            self.logger.log(
                "Pyright initial analysis complete, server ready", logging.INFO
            )
        else:
            self.logger.log(
