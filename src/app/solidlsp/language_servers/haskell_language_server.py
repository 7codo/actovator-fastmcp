...
class HaskellLanguageServer(SolidLanguageServer):
    ...
    def __init__(
        ...
        logger.log(
            f"Using haskell-language-server at: {hls_executable_path}", logging.INFO
        )
    ...
    def _start_server(self):
        ...
        def register_capability_handler(params):
            ...
            if "registrations" in params:
                for registration in params.get("registrations", []):
                    ...
                    self.logger.log(
                        f"HLS registered capability: {method}", logging.INFO
                    )
            return
        ...
        self.logger.log(
            "Haskell Language Server initialized successfully", logging.INFO
        )
