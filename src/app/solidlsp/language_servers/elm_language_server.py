...
class ElmLanguageServer(SolidLanguageServer):
    ...
    def _setup_runtime_dependencies(
        ...
        if system_elm_ls:
            logger.log(
                f"Found system-installed elm-language-server at {system_elm_ls}",
                logging.INFO,
            )
        ...
        if not os.path.exists(elm_ls_executable_path):
            ...
            with LogTime(
                "Installation of Elm language server dependencies", logger=logger.logger
            ):
    ...
    def _start_server(self):
        ...
        self.logger.log(
            "Elm server initialized successfully, waiting for workspace scan...",
            logging.INFO,
        )
